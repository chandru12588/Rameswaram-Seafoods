...
export default function Home() {
  return (
    <div className="w-full">
      {/* Hero Banner */}
      <section
        className="relative bg-[url('/home/hero.jpg')] 
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-2xl">
          <h1 className="text-4xl md:text-5xl font-bold drop-shadow-lg">Fresh Seafoods Delivered Daily</h1>
          <p className="text-lg mt-4 opacity-90">From the ocean to your kitchen - Fresh, Clean & Premium Quality.</p>

          <a href="/products" className="inline-block mt-6 px-8 py-3 rounded-lg bg-teal-500 hover:bg-teal-600 font-semibold">
            Order Now
          </a>
        </div>
      </section>
      ...
      <section className="text-center py-10 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-8">
          <div className="p-5 border rounded-lg shadow hover:shadow-lg transition bg-white">
            <span className="text-4xl">Fresh</span>
      ...
      <section className="py-10 text-center bg-white">
        ...
        <p className="text-gray-600 mt-2">Fresh catch updates, cleaning process, customer orders & daily offers!</p>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mt-6">
          <img src="/home/insta-1.jpg" className="rounded-lg shadow-md hover:scale-105 transition" alt="Seafood update 1" />
          <img src="/home/insta-2.jpg" className="rounded-lg shadow-md hover:scale-105 transition" alt="Seafood update 2" />
          <img src="/home/insta-3.jpg" className="rounded-lg shadow-md hover:scale-105 transition" alt="Seafood update 3" />
          <img src="/home/insta-4.png" className="rounded-lg shadow-md hover:scale-105 transition" alt="Seafood update 4" />
        </div>
      ...
      <section className="py-12 text-center bg-teal-50">
        ...
        <a href="/products" className="mt-5 inline-block bg-teal-600 text-white px-7 py-3 rounded-lg shadow hover:bg-teal-700">
          Shop Now
        </a>
      </section>
      ...
      >
        <img src="/home/whatsapp.svg" className="w-9 h-9" alt="WhatsApp Chat" />
      </a>
    </div>
  );
}